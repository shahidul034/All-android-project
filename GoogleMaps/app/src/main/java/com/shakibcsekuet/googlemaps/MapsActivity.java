package com.shakibcsekuet.googlemaps;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Button btnPharmacies = (Button) findViewById(R.id.btnPharmacies);
        ...
        btnPharmacies.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(MapsActivity.this,"Nearby library", Toast.LENGTH_LONG).show();
            }
        });
